...
public class ItemPic1 extends HttpServlet {
	Connection con;
...
//		res.setContentType("image/jpg");
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("select pic1 FROM MOVIEON.item WHERE itemId = '" + itemId + "'");


			if (rs.next()) {
			
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("pic1"));
