...
public class MemberJDBCDAO implements MemberDAO_interface {
	...
	private static final String INSERT_STMT = 
		"INSERT INTO MOVIEON.MEMBER VALUE (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	private static final String GET_ALL_STMT =
		"SELECT userid, username, email, password, address, mobile, joindate, profilepic, name, gender, birthday, education, occupation, ig, fb, twt, admin FROM MOVIEON.MEMBER order by userid";
	private static final String GET_ONE_STMT =
		"SELECT userid, username, email, password, address, mobile, joindate, profilepic, name, gender, birthday, education, occupation, ig, fb, twt, admin FROM MOVIEON.MEMBER where userid = ?";
