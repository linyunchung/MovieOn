...
public class MovieJDBCDAO implements MovieDAO_interface{
	...
	private static final String INSERT_STMT = 
		"INSERT INTO Movie (movieName,movieEName,releaseDate,mins,studio,plot,poster,actor,director, movieTag) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	private static final String GET_ALL_STMT = 
		"SELECT movieId,movieName,movieEName,releaseDate,mins,studio,plot,poster,actor,director,movieTag FROM Movie order by movieId";
	private static final String GET_ONE_STMT = 
		"SELECT movieId,movieName,movieEName,releaseDate,mins,studio,plot,poster,actor,director,movieTag FROM Movie where movieId = ?";
	private static final String UPDATE = 
		"UPDATE Movie set movieName=?, movieEName=?, releaseDate=?, mins=?, studio=?, plot=?,Poster=?, actor=?, director=?, movieTag=? where movieId = ?";
...
//		}
		...
		// 查詢名字
				List<MovieVO> list1 = dao.getAllByMovieName("金");
