...
public class ItemPic extends HttpServlet {
	Connection con;
...
//		res.setContentType("image/jpg");
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("select itemPic FROM MOVIEON.item WHERE itemId = '" + itemId + "'");


			if (rs.next()) {
			
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("ITEMPIC"));
