...
div.FastFurious-vid {
	background-image:
		url('https://img.youtube.com/vi/OqQnCAORVV8/hqdefault.jpg');
}
				...
				<ul class="navbar-nav ms-auto">
					<li class="nav-item dropdown"><a class="nav-link"
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item" href="/MOVIEON/moviesHome/movieGenre.jsp">電影類型</a></li>
		...
		<div class="youtube-carousel-wrap">
			<div class="youtube-carousel-main">
				<iframe id="main-youtube-video"
					src="https://www.youtube.com/embed/-gQHSE7cJg8" frameborder="0"
			...
			<div class="youtube-carousel-gallery" data-simplebar>
				...
				<div class="youtube-control FastFurious-vid"
					data-source="https://www.youtube.com/embed/OqQnCAORVV8">
					<p class="youtube-caption">玩命關頭9</p>
				</div>
