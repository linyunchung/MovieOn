			...
			<form METHOD="post" ACTION="orderInfo.do">				
				...
				<c:forEach var="itemVO" items="${shoppingCart}">
					<tr>
						...
						<td style="border: 1px solid rgb(230, 230, 230)">$${itemVO.itemQty * itemVO.price}</td>
					</tr>
                </c:forEach>
				...
				<table style="border: 1px solid rgb(230, 230, 230)">
					<tr>
						<td style="border: 1px solid rgb(230, 230, 230)"><p class="total">Total：$${orderTotal}</p></td>
					</tr>	
				</table>
				...
				<div class="msgs">
					...
					<div class="consignee">
						<table class="tconsignee">
							...
							<tr>
								...
								<td style="text-align: left"><input type="text" id="u_name" name="consignee" value="<%=(orderInfoVO == null) ? "" : orderInfoVO.getConsignee()%>" /></td>
							</tr>

							<tr>
								<td style="text-align: right">電話*：</td>
								<td style="text-align: left"><input type="tel" id="phone" name="mobile" value="<%=(orderInfoVO == null) ? "" : orderInfoVO.getMobile()%>" /></td>
							</tr>

							<tr>
								<td style="text-align: right">地址*：</td>
								<td style="text-align: left"><input type="text" id="addr" name="address" value="<%=(orderInfoVO == null) ? "" : orderInfoVO.getAddress()%>" /></td>
							</tr>
						</table>
					</div>
					...
					<div class="invoice">
						...
						<label for="personal">個人</label><br> <input type="radio" id="company" name="invoiceId" value='公司'><label for="company">公司</label>
						<p class="u_nump">統一編號：<input type="text" id="u_numbers" name="u_numbers" maxlength="8" size="8"></p>
					</div>
					...
					<div class="pay">
						...
						<div class="pay_form">
							<input type="radio" id="credit_card" name="paymentMethodId" value='信用卡'> 
							<label for="credit_card">信用卡付款</label>
							<br>
							<label id="card">信用卡卡號：</label> 
							<input type="text" class="card" maxlength="4"> 
							<input type="text" class="card" maxlength="4"> 
							<input type="text" class="card" maxlength="4"> 
							<input type="text" class="card" maxlength="4"> 
							<label class="datetime">有效日期：</label> 
							<input type="month" id="datetime" name="datetime"> 
							<label for="pin" class="pin">背面末三碼:</label> 
							<input type="text" id="pin" name="pin" size="1"> 
							<br> 
							<input type="radio" id="cash_home" name="paymentMethodId" value='貨到付款'> 
							<label for="cash_home">貨到付款</label>
							<br> 
							<input type="radio" id="atm" name="paymentMethodId" value='ATM轉帳'> 
							<label for="atm">ATM轉帳</label>
							<br> 
							<input type="radio" id="e_shop" name="paymentMethodId" value='超商付款'> 
							<label for="e_shop">超商付款</label>
						</div>
					</div>
					...
					<div class="deliver">
						...
						<div class="d_form">
							<input type="radio" id="d_home" name="deliveryMethodId" value='宅配到府'> <label for="d_home">宅配到府</label>
							<br>
							<input type="radio" id="d_shop" name="deliveryMethodId" value='超商取貨'> <label for="d_shop">超商取貨</label>
						</div>
					</div>
					...
					<div class="last_button">
						...
						<input type="submit" value="確認結帳" class="btn1">
					</div>
