...
public class MovieJDBCDAO implements MovieDAO_interface{
	...
	public void update(MovieVO movieVO) {
		...
		try {
			...
			pstmt.setString(11, movieVO.getMovieTag());
...
//		}
		...
		// 查詢名字
				List<MovieVO> list1 = dao.getAllByMovieName("2");
				for (MovieVO aMovie1 : list1) {
					...
					System.out.print(aMovie1.getReleaseDate() + ",");
					System.out.print(aMovie1.getMins() + ",");
					System.out.print(aMovie1.getStudio() + ",");
					System.out.print(aMovie1.getPlot() + ",");
					System.out.print(aMovie1.getPoster() + ",");
					System.out.print(aMovie1.getActor() +",");
					System.out.print(aMovie1.getDirector());
					System.out.print(aMovie1.getMovieTag());
					System.out.println("----------------");
				}
	}
