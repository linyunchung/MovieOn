...
<title>〔<%=movieVO.getMovieName()%>〕<%=reviewVO.getReviewTitle() %></title>
        ...
        <div class="content-area">
            <main class="site-main" role="main">
                <article class="post">
                    ...
                    <c:if test="<%= memberVO_2 == null || (!(memberVO_2.getUserid()).equals(reviewVO.getUserId()) && !follList.stream().anyMatch(f -> f.getTargetID() == reviewVO.getUserId())) %>">
                    ...
                    <c:if test="<%= memberVO_2 != null && (memberVO_2.getUserid()).equals(reviewVO.getUserId())%>">
