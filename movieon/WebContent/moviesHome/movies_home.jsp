...
<body>
    ...
    <section class="flex-gallery">
        <main class="main-gallery">
            <h4>最新上線</h4>
            <div class="gallery">
            	<c:forEach var="movieVO" items="${movieList}" begin="6" end="11">
               		<figure class="figure">
                    	<a href="<%=request.getContextPath()%>/Links_Controller?movieId=${movieVO.movieId}&action=getOneMovie_From_Home">
                    		<img src="<%=request.getContextPath()%>/DBGifReader_home?movieId=${movieVO.movieId}" class="figure-img img-fluid rounded" alt="photo">
                    		</a>
        ...
        <main class="main-gallery">
            <h4>最多人看</h4>
            <div class="gallery">
            	<c:forEach var="movieVO" items="${movieList}" begin="0" end="5">
                	<figure class="figure">
                    	<a href="<%=request.getContextPath()%>/Links_Controller?movieId=${movieVO.movieId}&action=getOneMovie_From_Home"><img src="<%=request.getContextPath()%>/DBGifReader_home?movieId=${movieVO.movieId}" class="figure-img img-fluid rounded" alt="photo"></a>
                    	<figcaption class="figure-caption">${movieVO.movieName}</figcaption>
                    	<p class="release">${movieVO.releaseDate}</p>
                	</figure>
                </c:forEach>
