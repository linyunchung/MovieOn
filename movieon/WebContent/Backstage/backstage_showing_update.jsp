    ...
    <c:if test="${successMsg.length()!=0 }">
      ...
      <form method="post" action="<%=request.getContextPath()%>/showing/showing.do">
        ...
        <jsp:useBean id="theaterSvc" scope="page" class="com.theater.model.TheaterService"/>
          ...
          <tr>
            <td>日期:</td>
            <td><input name="showingDate" type="text" class="datepicker" id="datepicker" value="<%=showingVO.getShowingDate()%>" autocomplete="off"></td>
          </tr>
          
          <tr>
            <td>場次時間:</td>
            <td><input name="showingTime" type="text" class="timepicker" value="<%=showingVO.getShowingTime()%>" autocomplete="off"></td>
          </tr>
