  ...
  <div class="content">
    <div class="aside">
      ...
      <div class="aside_search">
        <a class="aside_btn aside_show" href="<%=request.getContextPath()%>/showing/showing_search.jsp">場次查詢</a>
            ...
            <%for(ShowingVO showingVO : list){ %>
              ...
              <tr>
				...
				<form class="history_search_btn" method="post" action="<%=request.getContextPath()%>/history/historyview.do">		
					<button>
							<input type="hidden" name="movieId" value="<%=showingSvc.getOneShowing(showingVO.getShowingId()).getMovieId()%>">
							<input type="hidden" name="theaterId" value="<%=showingSvc.getOneShowing(showingVO.getShowingId()).getTheaterId()%>">
							<input type="hidden" name="showingDate" value="<%=showingSvc.getOneShowing(showingVO.getShowingId()).getShowingDate()%>">
