...
public class itemJDBCDAO implements itemDAO_interface {
	...
	private static final String UPDATE = 
		"UPDATE item set itemName=?, price=?, introduction=?, productSpecifications=?, inventory=?, salesVolume=?, shelfDate=?, itemPic=?, itemTag=?, pic1=?, pic2=?, pic3=? where itemId=?";
	...
	public void update(itemVO itemVO) {
		...
		try {
			...
			pstmt.setBytes(9, itemVO.getItemPic());
			pstmt.setString(10, itemVO.getItemTag());
			pstmt.setBytes(11, itemVO.getPic1());
			pstmt.setBytes(12, itemVO.getPic2());
			pstmt.setBytes(13, itemVO.getPic3());
...
//		System.out.println("---------------------");
		...
		for (itemVO aItemVO : list) {
			...
			System.out.println(aItemVO.getPic1());
			System.out.println(aItemVO.getPic2());
			System.out.println(aItemVO.getPic3());
			System.out.println("-----------------------");
		}
	}
}