...
//		//Creating a shared DAO
//		FollowDAOImpl dao = new FollowDAOImpl();
//		
//		//CREATE	      		
//		FollowVO vo1 = new FollowVO(2, 3);
//		//Relocated time-stamp to model, only 2 users is needed here. 
//		dao.create(vo1);
...
//		}
			...
			FollowDAOImpl daoimp = new FollowDAOImpl();
			FollowService fllwsvc = new FollowService();
			
			FollowVO followvo3 = fllwsvc.findBySourceAndTarget(2, 1);
			System.out.println(followvo3);
			
//			FollowVO followvo = daoimp.findBySourceAndTarget(2, 1);
//			System.out.println(followvo);
			
//			FollowVO followvo2 = daoimp.findByID(1);
//			System.out.println(followvo2);
