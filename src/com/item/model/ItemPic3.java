...
public class ItemPic3 extends HttpServlet {
	Connection con;
...
//		res.setContentType("image/jpg");
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("select pic3 FROM MOVIEON.item WHERE itemId = '" + itemId + "'");


			if (rs.next()) {
			
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("pic3"));
