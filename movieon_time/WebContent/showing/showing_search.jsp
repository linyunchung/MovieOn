...
<% 	MemberService memberSvc = new MemberService(); 
	MemberVO memberVO = memberSvc.getoneMember(3);
	...
	<div class="content">
		<div class="aside">
			...
			<div class="aside_search">
				<a class="aside_btn aside_show" href="../html/showing.html">場次查詢</a>
		...
		<div class="main">
			<div class="select_search">
				...
				<form method="post" action="<%=request.getContextPath()%>/showing/showingview.do" name="form">
					...
					選擇地區 <select name="select_search_area" onchange="selectArea()"
						onload="selectArea()" id="area_city">
