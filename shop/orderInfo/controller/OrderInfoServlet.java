...
//					orderInfoSvc.addOrderListVO(orderTotal, orderStatus, orderDate, paymentMethodId, deliveryMethodId,
//							consignee, mobile, address, invoiceId, userid, orderTotal, payStatus, orderListVOList);
