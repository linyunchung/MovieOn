        ...
        <div class="tab-content">
            <section class="tab-panel" id="tab-1">
                <div class="gallery">
                	...
                	%>
                    <figure class="figure">
                        <a target="_blank" href="<%=request.getContextPath()%>/Links_Controller?movieId=<%=list.get(i).getMovieId() %>&action=getOneMovie_From_Home">
                ...
                <div class="gallery">
                	<c:forEach var="movieVO" items="${movieSvc.all}">
                		<c:if test="${movieVO.movieTag eq '喜劇片'}">
                    		<figure class="figure">
                        		<a target="_blank" href="<%=request.getContextPath()%>/Links_Controller?movieId=${movieVO.movieId}&action=getOneMovie_From_Home"><img src="<%=request.getContextPath()%>/DBGifReader_home?movieId=${movieVO.movieId}" class="figure-img img-fluid rounded" alt="..."></a>
