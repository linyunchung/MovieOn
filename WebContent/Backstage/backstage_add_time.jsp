...
<link
 ...
 <link rel="stylesheet" href="<%=request.getContextPath() %>/datetimepicker/jquery-ui.css">
</head>
<body>
<!-- header部分include -->
    ...
    <c:if test="${successMsg.length()!=0 }">
      ...
      <form method="post" action="<%=request.getContextPath()%>/showing/showing.do">
        ...
        <jsp:useBean id="theaterSvc" scope="page" class="com.theater.model.TheaterService"/>
          <tr>
            ...
            <td>
              ...
              <c:forEach var="theaterVO" items="${theaterSvc.all }">
                <option value="${theaterVO.theaterId }" ${(showingVO.theaterId==theaterVO.theaterId)? 'selected' : '' }>${theaterVO.theaterName}
                </c:forEach>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              ...
              <c:forEach var="movieVO" items="${movieSvc.all}">
                <option value="${movieVO.movieId }" ${(showingVO.movieId==movieVO.movieId) ? 'selected' : '' }>${movieVO.movieName}
              </c:forEach>
              </select>
            </td>
          </tr>
          ...
          <tr>
            <td>日期:</td>
            <td><input name="showingDate" type="text" class="datepicker" id="datepicker" value="<%=showingDate%>" autocomplete="off" placeholder="必填" ></td>
          </tr>
          
          <tr>
            <td>場次時間:</td>
            <td><input name="showingTime" type="text" class="timepicker" value="<%=showingTime%>" autocomplete="off" placeholder="必填" ></td>
          </tr>
          
          <tr>
          	<td>新增時間:</td>
            <td><input name="showingTime2" type="text" class="timepicker" autocomplete="off" placeholder="選填"></td>
          </tr>
          
          <tr>
          	<td>新增時間:</td>
            <td><input name="showingTime3" type="text" class="timepicker" autocomplete="off" placeholder="選填"></td>
          </tr>
          
          <tr>
          	<td>新增時間:</td>
            <td><input name="showingTime4" type="text" class="timepicker" autocomplete="off" placeholder="選填"></td>
          </tr>
...
<script src="<%=request.getContextPath() %>/datetimepicker/datepicker.js"></script>
