...
public class MovieJDBCDAO implements MovieDAO_interface {
	...
	private static final String INSERT_STMT = 
		"INSERT INTO MOVIEON.Movie (movieName,movieEName,releaseDate,mins,studio,plot,poster,actor,director) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
	private static final String GET_ALL_STMT = 
		"SELECT movieId,movieName,movieEName,releaseDate,mins,studio,plot,poster,actor,director FROM MOVIEON.Movie order by movieId";
	private static final String GET_ONE_STMT = 
		"SELECT movieId,movieName,movieEName,releaseDate,mins,studio,plot,poster,actor,director FROM MOVIEON.Movie where movieId = ?";
	private static final String UPDATE = 
		"UPDATE MOVIEON.Movie set movieName=?, movieEName=?, releaseDate=?, mins=?, studio=?, plot=?, poster=?, actor=?, director=? where movieId = ?";
