		...
		<div class="row">
			<div class="col">
				<form method="POST" action="ReviewServlet" class="review" name="form1" autocomplete="off">
					<h4>編輯影評</h4>
					<input type="hidden" name="userId" readonly value="<%=reviewVO.getUserId()%>"><br>
					<label>會員名稱</label> 
					<input type="TEXT" name="username" readonly value="<%=memberSvc.getOneMember(reviewVO.getUserId()).getUsername()%>"><br>    
